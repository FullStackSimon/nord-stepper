export declare const enum DaysOfWeek {
    Sunday = 0,
    Monday = 1,
    Tuesday = 2,
    Wednesday = 3,
...
export declare function getDayNames(locale: string, weekday: Exclude<Intl.DateTimeFormatOptions["weekday"], undefined>): string[];
export declare function getMonthNames(locale: string, month: Exclude<Intl.DateTimeFormatOptions["month"], undefined>): string[];
/**
